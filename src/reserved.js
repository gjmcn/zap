const reserved = {
  ...
  commands: new Set([
    ...
    '$do', '$asyncDo', '$while', '$asyncWhile', '$nest', '$zip', '$seq',
    '$throw', '$try', '$awaitTry', '$debugger', '$print', '$reduce', '$some',
    '$every', '$filter', '$min', '$minIndex', '$max', '$maxIndex', '$sum',
    ...
    '$importDefault', '$importAll', '$ms', '$at', '$ats', '$to', '$linSpace'
  ]),
